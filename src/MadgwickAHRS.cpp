...
MadgwickAHRS::MadgwickAHRS(const float beta)
    : beta(beta), prevSampleTime(getExactTime()), q{1.0f, 0.0f, 0.0f, 0.0f} {
}

void MadgwickAHRS::update(const millisecond_t sampleTime, const point3<rad_per_sec_t>& gyro,
                          const point3<m_per_sec2_t>& accel, const point3<gauss_t>& mag) {
    ...
    hx = mx * q0q0 - _2q0my * q.q3 + _2q0mz * q.q2 + mx * q1q1 + _2q1 * my * q.q2 +
         _2q1 * mz * q.q3 - mx * q2q2 - mx * q3q3;
    hy = _2q0mx * q.q3 + my * q0q0 - _2q0mz * q.q1 + _2q1mx * q.q2 - my * q1q1 + my * q2q2 +
         _2q2 * mz * q.q3 - my * q3q3;
    _2bx = sqrt(hx * hx + hy * hy);
    _2bz = -_2q0mx * q.q2 + _2q0my * q.q1 + mz * q0q0 + _2q1mx * q.q3 - mz * q1q1 +
           _2q2 * my * q.q3 - mz * q2q2 + mz * q3q3;
    _4bx = 2.0f * _2bx;
    _4bz = 2.0f * _2bz;

    // Gradient decent algorithm corrective step
    s0 = -_2q2 * (2.0f * q1q3 - _2q0q2 - ax) + _2q1 * (2.0f * q0q1 + _2q2q3 - ay) -
         _2bz * q.q2 * (_2bx * (0.5f - q2q2 - q3q3) + _2bz * (q1q3 - q0q2) - mx) +
         (-_2bx * q.q3 + _2bz * q.q1) * (_2bx * (q1q2 - q0q3) + _2bz * (q0q1 + q2q3) - my) +
         _2bx * q.q2 * (_2bx * (q0q2 + q1q3) + _2bz * (0.5f - q1q1 - q2q2) - mz);
    s1 = _2q3 * (2.0f * q1q3 - _2q0q2 - ax) + _2q0 * (2.0f * q0q1 + _2q2q3 - ay) -
         4.0f * q.q1 * (1 - 2.0f * q1q1 - 2.0f * q2q2 - az) +
         _2bz * q.q3 * (_2bx * (0.5f - q2q2 - q3q3) + _2bz * (q1q3 - q0q2) - mx) +
         (_2bx * q.q2 + _2bz * q.q0) * (_2bx * (q1q2 - q0q3) + _2bz * (q0q1 + q2q3) - my) +
         (_2bx * q.q3 - _4bz * q.q1) * (_2bx * (q0q2 + q1q3) + _2bz * (0.5f - q1q1 - q2q2) - mz);
    s2 = -_2q0 * (2.0f * q1q3 - _2q0q2 - ax) + _2q3 * (2.0f * q0q1 + _2q2q3 - ay) -
         4.0f * q.q2 * (1 - 2.0f * q1q1 - 2.0f * q2q2 - az) +
         (-_4bx * q.q2 - _2bz * q.q0) * (_2bx * (0.5f - q2q2 - q3q3) + _2bz * (q1q3 - q0q2) - mx) +
         (_2bx * q.q1 + _2bz * q.q3) * (_2bx * (q1q2 - q0q3) + _2bz * (q0q1 + q2q3) - my) +
         (_2bx * q.q0 - _4bz * q.q2) * (_2bx * (q0q2 + q1q3) + _2bz * (0.5f - q1q1 - q2q2) - mz);
    s3 = _2q1 * (2.0f * q1q3 - _2q0q2 - ax) + _2q2 * (2.0f * q0q1 + _2q2q3 - ay) +
         (-_4bx * q.q3 + _2bz * q.q1) * (_2bx * (0.5f - q2q2 - q3q3) + _2bz * (q1q3 - q0q2) - mx) +
         (-_2bx * q.q0 + _2bz * q.q2) * (_2bx * (q1q2 - q0q3) + _2bz * (q0q1 + q2q3) - my) +
         _2bx * q.q1 * (_2bx * (q0q2 + q1q3) + _2bz * (0.5f - q1q1 - q2q2) - mz);
