...
LSM6DSO_Gyroscope::LSM6DSO_Gyroscope(const i2c_t& i2c) : LSM6DSO_Gyroscope(i2c, SPI_DEFAULT, GPIO_DEFAULT) {}

LSM6DSO_Gyroscope::LSM6DSO_Gyroscope(const spi_t& spi, const gpio_t& cs) : LSM6DSO_Gyroscope(I2C_DEFAULT, spi, cs) {}

LSM6DSO_Gyroscope::LSM6DSO_Gyroscope(const i2c_t& i2c, const spi_t& spi, const gpio_t& cs)
    : handle_{ i2c, spi, cs }
    , dev_ctx_{ write, read, &this->handle_ } {}
