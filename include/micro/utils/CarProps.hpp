...
struct CarProps {
    ...
    bool operator==(const CarProps& other) {
        return this->pose == other.pose && this->speed == other.speed &&
               this->distance == other.distance && this->orientedDistance == other.distance &&
               this->frontWheelAngle == other.frontWheelAngle &&
               this->rearWheelAngle == other.rearWheelAngle && this->yawRate == other.yawRate &&
    ...
    meter_t orientedDistance; // The distance that the has driven with no major orientation change
                              // (in a straight line).
