...
struct Line {
    ...
    millimeter_t
        pos; ///< The line position at the front sensor line (relative to car vertical middle axis).
...
struct OrientedLine {
    ...
    bool operator==(const OrientedLine& other) const {
        return this->pos == other.pos && this->angle == other.angle;
    }
...
struct MainLine {
    ...
    Line frontLine; ///< The position of the line at the front sensor row - in the front sensor
                    ///< row's coordinate system
    Line rearLine;  ///< The position of the line at the rear sensor row - in the rear sensor row's
                    ///< coordinate system
    OrientedLine centerLine; ///< The followed line - in the car's current direction's coordinate
                             ///< system. @note This will be the control input.
